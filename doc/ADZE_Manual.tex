...
grouping and locus, one column per $g$, tab-separated with a header. A value
undefined at that $g$ is \texttt{NA}.

\begin{Verbatim}[xleftmargin=1em,fontsize=\small]
POP_GROUPING    LOCUS   G1      G2      G3
POP1            L0      1       1.53571 1.80357
POP1            L1      1       1.60714 2
POP1            L2      1       1       NA
POP1            L3      1       1.67857 2.125
\end{Verbatim}
...
\begin{Verbatim}[xleftmargin=1em,fontsize=\small]
awk -F'\t' 'NR>1 {print $1, $2, $3}' out.richness_fulldata    # label, locus, g=1
\end{Verbatim}
...
\item The \texttt{\_fulldata} files are transposed: one row per grouping and
