...
Windows:          12 of 50000 bp, step 25000
  loci per window: 5-10
  richness rows:   960
  private rows:    960
\end{Verbatim}

\noindent Twelve windows, none thinner than five loci, and $g$ running from 1
to 20 everywhere because every grouping has 24 gene copies and the sparsest
locus still carries 20 --- twelve windows times twenty values of $g$ times four
groupings. Then run it, with a floor on how thin a window may be:
...
\noindent Nine hundred and sixty rows is more than a scan is usually read at.
Adding \flag{--at-g 10} asks for one $g$ and gives 48 --- one row per window
per grouping:

\begin{Verbatim}[frame=single,fontsize=\small]
CHROM  START   END     POP_GROUPING  G   NUM_LOCI  MEAN     VAR        STD_ERR
chr1   1       50000   POP0          10  10        3.43492  0.0673694  0.0820789
chr1   25001   75000   POP0          10  10        3.55669  0.0546877  0.0739512
\end{Verbatim}
